            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="text-sm font-semibold text-blue-900 mb-1">
                  Evaluasi Menggunakan LLM (Large Language Model)
                </h3>
                <p className="text-xs text-blue-700">
                  Sistem evaluasi sekarang menggunakan AI untuk memberikan penilaian yang lebih kontekstual dan cerdas. 
                  Setiap atribut dievaluasi berdasarkan pemahaman makna dan kualitas konten, bukan hanya aturan sederhana.
                </p>
              </div>
            </div>
          </div>
