...
const Sidebar = () => {
  ...
  return (
    <div className="fixed h-screen bg-gradient-to-b from-blue-500 to-blue-700 text-white w-[150px] flex flex-col overflow-hidden">
              ...
              <li key={index}>
                <Link
                  ...
                  className={`flex items-center px-4 py-3 text-sm ${
                    isActive(item.path) ? "bg-blue-600" : "hover:bg-blue-600"
                  }`}
                >
